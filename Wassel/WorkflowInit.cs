...
namespace Wassel
{
    public static class WorkflowInit
    {
        ...
        private static WorkflowRuntime InitWorkflowRuntime()
        {
            ...
            ConnectionString = "Server=DESKTOP-DBTMIPO;Database=Wassel;Trusted_Connection=True;MultipleActiveResultSets=true";
           // ConnectionString = "Server=localhost,1433;Initial Catalog=MyDb;Port=5432;Database=Wassel;Persist Security Info=False;User ID=admin;Password=Admin;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
